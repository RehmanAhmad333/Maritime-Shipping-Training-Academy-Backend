...
def create_alert(
    ...
    try:
        ...
        background_tasks.add_task(
            ...
            current_user.email,
            "Email Alert Created",
            f"Your email alert has been created successfully. You will receive notifications when new courses matching your criteria are added."
        )
        ...
        db.rollback()
        logger.error(f"Database error creating alert for user {current_user.id}: {str(e)}")
        raise HTTPException(
